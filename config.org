...
;; Ensure yasnippet-capf integrates with cape, but only for current mode's snippets
(defun my/yas-capf ()
  "Provide completion for yasnippet, but only show mode-specific snippets."
  (let ((yas-buffer-local-condition
         '(require-snippet-condition . force-in))) ;; Only active mode snippets
    (yasnippet-capf)))
...
(use-package yasnippet-capf
  ...
  (add-to-list 'completion-at-point-functions #'my/yas-capf))
