		  ...
		  (lambda ()
		    ...
		    (when (string-suffix-p "server" server-name)
			 ...
			 (dolist (lib '("org" "ob" "ox" "ol" "org-roam"
				       ...
				       "magit" "modus-themes" "ewal" "ewal-doom-themes" "diff-hl"
